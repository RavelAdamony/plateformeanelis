...
class Version2_00_007 extends AbstractMigration {
    ...
    public function up(Schema $schema) {
          ...
          try {
            ...
            $this->addSql('CREATE TABLE newsletter (id INT AUTO_INCREMENT NOT NULL, newsletter VARCHAR(255) NOT NULL, commentaire VARCHAR(255) NOT NULL, frequence VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB;');
            ...
            $this->addSql('INSERT INTO `newsletter` (`id`, `newsletter`, `commentaire`, `frequence`) VALUES(2,"mlEvents","Tout les événements en France","mensuel");');
