...
$catalogue = new MessageCatalogue('fr', array (
  ...
  array (
    ...
    'security.login.username' => 'Nom d\'utilisateur ou adresse mail',
    ...
    'registration.check_email' => 'Un e-mail a été envoyé à l\'adresse %email%. Il contient un lien d\'activation sur lequel il vous faudra cliquer afin d\'activer votre compte. Le mail de confirmation peut mettre quelques minutes avant réception.',
    'registration.confirmed' => 'Félicitations %username%, votre compte est maintenant activé. Vous allez être déconnecté en attente d’une validation de la part des administrateurs.',
...
Si vous rencontrez des problèmes, contactez nous : support@anelis.org
