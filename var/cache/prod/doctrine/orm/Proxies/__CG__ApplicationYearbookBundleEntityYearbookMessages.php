...
namespace Proxies\__CG__\Application\YearbookBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class YearbookMessages extends \Application\YearbookBundle\Entity\YearbookMessages implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Application\\YearbookBundle\\Entity\\YearbookMessages' . "\0" . 'id', '' . "\0" . 'Application\\YearbookBundle\\Entity\\YearbookMessages' . "\0" . 'userFrom', '' . "\0" . 'Application\\YearbookBundle\\Entity\\YearbookMessages' . "\0" . 'userTo', '' . "\0" . 'Application\\YearbookBundle\\Entity\\YearbookMessages' . "\0" . 'message', '' . "\0" . 'Application\\YearbookBundle\\Entity\\YearbookMessages' . "\0" . 'yearbook'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (YearbookMessages $proxy) {
    ...
    public function setYearbook(\Application\YearbookBundle\Entity\Yearbook $yearbook)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setYearbook', [$yearbook]);

        return parent::setYearbook($yearbook);
    }
    ...
    public function getYearbook()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getYearbook', []);

        return parent::getYearbook();
    }
