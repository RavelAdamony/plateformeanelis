 ...
 */
class Yearbook extends \Application\YearbookBundle\Entity\Yearbook implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Application\\YearbookBundle\\Entity\\Yearbook' . "\0" . 'id', '' . "\0" . 'Application\\YearbookBundle\\Entity\\Yearbook' . "\0" . 'promotion', '' . "\0" . 'Application\\YearbookBundle\\Entity\\Yearbook' . "\0" . 'activated', '' . "\0" . 'Application\\YearbookBundle\\Entity\\Yearbook' . "\0" . 'messages'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Yearbook $proxy) {
    ...
    public function addMessage(\Application\YearbookBundle\Entity\YearbookMessages $messages)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addMessage', [$messages]);
    ...
    public function removeMessage(\Application\YearbookBundle\Entity\YearbookMessages $messages)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeMessage', [$messages]);
