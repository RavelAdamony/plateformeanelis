 ...
 */
class FileOffre extends \Application\OffreBundle\Entity\FileOffre implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Application\\OffreBundle\\Entity\\FileOffre' . "\0" . 'id', '' . "\0" . 'Application\\OffreBundle\\Entity\\FileOffre' . "\0" . 'filename', '' . "\0" . 'Application\\OffreBundle\\Entity\\FileOffre' . "\0" . 'path', 'file'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (FileOffre $proxy) {
    ...
    public function taillefile()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'taillefile', []);

        return parent::taillefile();
    }
