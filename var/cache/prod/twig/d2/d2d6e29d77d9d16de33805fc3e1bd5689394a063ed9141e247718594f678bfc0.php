...
class __TwigTemplate_5e1bad3b9ec432350b4fd70b7d03352e709be2f348123e6ec2d92e7c97771ffb extends Twig_Template
{
...
";
        // line 12
        if (($this->getAttribute(($context["admin"] ?? null), "isGranted", array(0 => "DELETE", 1 => ($context["object"] ?? null)), "method") && $this->getAttribute(($context["admin"] ?? null), "hasRoute", array(0 => "delete"), "method"))) {
            // line 13
            echo "    <a href=\"";
...
";
    ...
    {
        return new Twig_Source("", "SonataAdminBundle:CRUD:list__action_delete.html.twig", "D:\\WAMP\\www\\plateformeanelis\\vendor\\sonata-project\\admin-bundle/Resources/views/CRUD/list__action_delete.html.twig");
    }
}
