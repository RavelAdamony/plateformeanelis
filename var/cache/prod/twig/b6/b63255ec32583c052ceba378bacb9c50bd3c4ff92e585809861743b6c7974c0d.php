...
class __TwigTemplate_8ece5f12b63e735afc41508b30af2fbc9b29b7b508c874bb9e5687efdb120378 extends Twig_Template
{
...
";
    ...
    <select class=\"per-page small form-control\" id=\"";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["per_page"]) {
            ...
            echo " value=\"";
            echo twig_escape_filter($this->env, $this->getAttribute(($context["admin"] ?? null), "generateUrl", array(0 => "list", 1 => array("filter" => twig_array_merge($this->getAttribute($this->getAttribute(($context["admin"] ?? null), "datagrid", array()), "values", array()), array("_page" => 1, "_per_page" => $context["per_page"])))), "method"), "html", null, true);
            echo "\">";
            // line 27
...
";
    ...
    {
        return new Twig_Source("", "SonataAdminBundle:Pager:base_results.html.twig", "D:\\WAMP\\www\\plateformeanelis\\vendor\\sonata-project\\admin-bundle/Resources/views/Pager/base_results.html.twig");
    }
}
